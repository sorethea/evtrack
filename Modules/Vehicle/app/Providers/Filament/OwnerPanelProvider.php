...
namespace Modules\Vehicle\Providers\Filament;
...
class OwnerPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->discoverResources(in: module("Vehicle", true)->appPath("Filament{$separator}VehicleOwner{$separator}Resources"), for: module("Vehicle", true)->appNamespace('Filament\VehicleOwner\Resources'))
            ->discoverPages(in:module("Vehicle", true)->appPath("Filament{$separator}VehicleOwner{$separator}Pages"), for: module("Vehicle", true)->appNamespace('Filament\VehicleOwner\Pages'))
            ->pages([
                Dashboard::class,
            ])
